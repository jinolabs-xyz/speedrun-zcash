...
export const challenges: Challenge[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        detail:
          'Copy your Sapling address and request TAZ from the Zcash testnet faucet, an open source ecosystem tool that runs its own node and pays you with a real shielded transaction. Then wait for the wallet to sync it. Drips to the unified address end up in the new Ironwood pool that this wallet cannot scan yet, so Sapling is the one to use. Testnet coins are worthless, which makes them perfect for breaking things.',
        verification: 'chain',
      },
      {
        id: 'send',
